...
<pre style="position: relative;"><strong>Input:</strong> folder = ["/a","/a/b","/c/d","/c/d/e","/c/f"]
...
<pre style="position: relative;"><strong>Input:</strong> folder = ["/a","/a/b/c","/a/b/d"]
...
<pre style="position: relative;"><strong>Input:</strong> folder = ["/a/b/c","/a/b/ca","/a/b/d"]
